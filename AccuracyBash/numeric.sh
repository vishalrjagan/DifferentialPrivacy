...
make acc_silent INPUT=acc_2_numeric_c2_width1_gamma1.txt TYPE=1 NUMQ=2 RANGEWIDTH=1 C=2 ALPHA=1
make acc_silent INPUT=acc_2_numeric_c2_width2_gamma1.txt TYPE=1 NUMQ=2 RANGEWIDTH=2 C=2 ALPHA=1
